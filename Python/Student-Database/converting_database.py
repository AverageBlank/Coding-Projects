def func_excel(x):
    ...
    # While Loop
    while True:
        b = input('Do you want to store the students in an excel worksheet(Type in either yes or no)? ').lower()
        sleep(1)
        if b != 'yes' and b != 'no':
            continue
        elif b == 'no':
        ...
        while 3*a != n:
            ...
            if x[index][5] == 1:
                ...
                worksheet.write(1+n,10, x[index][6]['secondL'], cell_format)
                ...
                worksheet.write(1+n,9,  x[index][6]['secondL'], cell_format)
                ...
                worksheet.write(1+n,8,  "English", cell_format)
                worksheet.write(1+n,10, x[index][6]['secondL'], cell_format)
                worksheet.write(1+n,9,  x[index][6]['thirdL'], cell_format)
                worksheet.write(1+n,11, "Computers", cell_format)
